...
function [ExATSrna_ATS, prna, ExATSrna] = validate_2(prna, ExATSrna, ChOrder, iminfo, nuc)
% version 2 changes 2 lines of code to make the validation work, directly
% assigning match elements to 1212 or 2121
...
% 'prnas{}' 1:3 col = x,y,z coor, 4 col = nuc assciated? | 5th: vol ratio to mean vol per spot |
%               | 6th: total sig intensity (trx activity) | 7: z-coor in plane # | 8: RNA ID.
%               | 9: count for Voronoi matching | 10: Voronoi count w/ limit (vLim) |
%               | 11: # total ROI (overlapped) | 12: distance to closest nucleus|
