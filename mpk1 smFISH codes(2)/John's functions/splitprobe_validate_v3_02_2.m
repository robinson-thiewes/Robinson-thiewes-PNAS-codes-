...
if ~isempty(prna{ChOrder == 1}) %if prna(intron 1st half) is NOT empty
    ...
    for i = 1:length(prna{ChOrder == 1}(:,1)) %i=length of x-coordinates
        ...
        if distMats12(1,4) <= distATS/iminfo(6)%if hypotenuse is <= distance ATS/iminfo (um)
            prna{ChOrder == 1}(i,9) = 1212;%If exon (all exon spots, RNA ID) equals (==) distMats12(1st vs exon)RNA ID,
            ...
            prna{ChOrder == 1}(i,9) = -1; %put exon matching into prna(1st) into column 9
        end
    end
    ...
    for i = 1:length(prna{ChOrder == 1}(:,1)) %i=length of x-coordinates
        ...
        if distMats13(1,4) <= distATS/iminfo(6)
            prna{ChOrder == 1}(i,12) = 1313;%If 2nd (all 2nd spots, nuc #) equals (==) distMats13(1st vs 2nd) nuclear number,
            ...
            prna{ChOrder == 1}(i,12) = -1; %put 2nd matching into prna(2nd) into column 12
        end
...
if ~isempty(prna{ChOrder == 3}) %if 2nd half not empty
    ...
    for i = 1:length(prna{ChOrder == 3}(:,1)) %i=length of x-coordinates
        ...
        if distMats32(1,4) <= distATS/iminfo(6)
            prna{ChOrder == 3}(i,9) = 2323;%If exon (all exon spots, RNA ID) equals (==) distMats32(2nd vs exon) RNA ID,
            ...
            prna{ChOrder == 3}(i,9) = -1; %put exon matching into prna(2nd) into column 9
        end
    end
    ...
    for i = 1:length(prna{ChOrder == 3}(:,1)) %i=length of x-coordinates
        ...
        if distMats31(1,4) <= distATS/iminfo(6)
            prna{ChOrder == 3}(i,12) = 1212;%If 1st (all 1st spots, nuc #) equals (==) distMats21(2nd vs 1st) nuc #,
            ...
            prna{ChOrder == 3}(i,12) = -1; %put 1st matching into prna(2nd) into column 12
        end
...
if ~isempty(prna{ChOrder == 2}) %for exon channel ATS
    for i = 1:length(prna{ChOrder == 2}(:,1)) %i=length of x-coordinates
        ...
        if distMats21(1,4) <= distATS/iminfo(6)
            prna{ChOrder == 2}(i,13) = 3131;%If 1st (all 1st spots, nuc #) equals (==) distMats21(exon vs 1st) nuc #,
            ...
            prna{ChOrder == 2}(i,13) = -1; %put 1st matching into prna(exon) into column 13
        end
    end
    ...
    for i = 1:length(prna{ChOrder == 2}(:,1)) %i=length of x-coordinates
        ...
        if distMats23(1,4) <= distATS/iminfo(6)
            prna{ChOrder == 2}(i,16) = 3232;%If 1st (all 2nd spots, nuc #) equals (==) distMats23(exon vs 2nd) nuc #,
            ...
            prna{ChOrder == 2}(i,16) = -1; %put 2nd matching into prna(exon) into column 16
        end
